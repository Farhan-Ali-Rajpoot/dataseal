...
#line 144 "/home/farhanali/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.10/src/lib.rs"

extern "C" {
    void (*rust_cpp_callbacks5673508652729812997[6])() = {};
}
...
#line 220 "/home/farhanali/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.10/src/lib.rs"
...
#line 239 "/home/farhanali/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.10/src/lib.rs"
...
#line 136 "src/itemmodel.rs"
            ...
            for (QModelIndex &idx : list2) {
                reinterpret_cast<void (*)(rustcpp::argument_helper<TraitObject>::type, rustcpp::argument_helper<QModelIndex &>::type)>(rust_cpp_callbacks5673508652729812997[0])(f, idx)
...
#line 163 "src/scenegraph.rs"
                ...
                if (raw->size != len || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks5673508652729812997[1])();
                }
                return raw->mask;
...
#line 224 "src/scenegraph.rs"
                ...
                if (raw->size != std::size_t(-1) || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks5673508652729812997[2])();
                }
                return raw->mask;
...
#line 255 "src/scenegraph.rs"
                ...
                if (!node) reinterpret_cast<void (*)()>(rust_cpp_callbacks5673508652729812997[3])();
...
#line 265 "src/scenegraph.rs"
                ...
                if (!node->parent()) {
                    ...
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks5673508652729812997[4])();
                }
...
#line 443 "src/scenegraph.rs"
            ...
            if (!node->parent()) {
                ...
                reinterpret_cast<void (*)()>(rust_cpp_callbacks5673508652729812997[5])();
            }
            node->setFlag(QSGNode::OwnedByParent);
...
#line 300 "/home/farhanali/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.10/src/lib.rs"
...
MetaData metadata_5673508652729812997 = {
